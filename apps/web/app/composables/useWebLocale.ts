...
const webMessages: Record<WebLocale, WebCopyDictionary> = {
  'zh-CN': {
    ...
    'theme.light': '浅色',
    'theme.dark': '深色',
    'footer.milestone': 'Web milestone W5 · i18n and Theme System',
    'footer.description': '当前阶段已建立前台语言切换、主题状态封装与内容/界面文案边界。',
    'page.home.description': '个人内容展示站首页，承载个人简介、简历入口与项目展示入口。',
    'page.resume.title': '在线简历 · Fridolph Web',
    'page.resume.description': '在线简历页面已接入结构化内容与语言切换能力。',
    'page.projects.title': '项目列表 · Fridolph Web',
    'page.projects.description': '项目列表页面已接入结构化内容与语言切换能力。',
    'page.projectDetail.description': '项目详情页已接入结构化内容与语言切换能力。',
  ...
  'en-US': {
    ...
    'theme.dark': 'Dark',
    'footer.milestone': 'Web milestone W5 · i18n and Theme System',
    'footer.description': 'Frontend locale switching, theme state, and content/UI copy boundaries are now in place.',
    'page.home.description': 'Homepage for personal introduction, resume entry, and project entry points.',
    'page.resume.title': 'Resume · Fridolph Web',
    'page.resume.description': 'The resume page now supports structured content and locale switching.',
    'page.projects.title': 'Projects · Fridolph Web',
    'page.projects.description': 'The projects page now supports structured content and locale switching.',
    'page.projectDetail.description': 'The project detail page now supports structured content and locale switching.',
