          ...
          return (
            ...
            >
              <div className={itemHeaderClass}>
                <div className={itemHeaderMainClass}>
                  ...
                  <div className="grid gap-1.5">
                    ...
                    {roleLine ? (
                      <p className={itemMetaTextClass}>{roleLine}</p>
                    ) : null}
                  </div>
                </div>
              ...
              <div className="grid gap-4">
                {summary ? (
                  <div className={itemBlockClass}>
                    <p className={itemBlockLabelClass}>{locale === 'zh' ? '职责概览' : 'Summary'}</p>
                    <p className={itemSummaryClass}>{summary}</p>
                  </div>
                ) : null}
                {location ? (
                  <div className={itemBlockClass}>
                    <p className={itemBlockLabelClass}>{locale === 'zh' ? '地点' : 'Location'}</p>
              ...
              {experience.highlights.length > 0 ? (
                <div className={itemBlockClass}>
                  <p className={itemBlockLabelClass}>{locale === 'zh' ? '关键亮点' : 'Highlights'}</p>
