...
export const navBadgeCollapsedClass = 'h-10 w-10 bg-transparent'
export const sidebarShellClass =
  'sticky top-0 hidden h-screen self-start border-none bg-transparent md:block'
export const sidebarHeaderClass = 'flex flex-col items-stretch gap-4 px-3 py-4 pb-3'
export const sidebarHeaderCollapsedClass = 'items-center px-[0.55rem]'
export const sidebarBrandClass = 'flex w-full items-center justify-between gap-2'
export const sidebarBrandCollapsedClass = 'flex-col justify-start gap-3'
...
export const sidebarContentCollapsedClass = 'items-center px-[0.55rem]'
...
export const sessionDropdownPopoverClass = 'min-w-[220px]'
export const sessionDropdownMenuClass = 'p-[0.35rem]'
