  ...
  return (
    <Drawer.Backdrop
      ...
      <Drawer.Content placement="right">
        <Drawer.Dialog className="max-w-[min(92vw,58rem)]">
            ...
            <div className="grid gap-2">
              ...
              {record ? (
                <p className="text-sm leading-6 text-zinc-500 dark:text-zinc-400">
                  {formatScenario(record.scenario)} · {formatLocale(record.locale)} ·{' '}
          ...
          <Drawer.Body className="grid gap-5 px-5 py-5">
            {record ? (
              <>
                <div className="rounded-[1.25rem] border border-zinc-200/80 bg-zinc-50/72 p-4 text-sm leading-6 text-zinc-600 dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-300">
