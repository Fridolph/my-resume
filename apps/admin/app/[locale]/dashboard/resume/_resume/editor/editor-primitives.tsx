    ...
    <Tooltip delay={300}>
      <Tooltip.Trigger>
        <Button
          ...
          aria-label={label}
          className={[
            'inline-flex h-10 w-10 min-w-10 items-center justify-center rounded-full px-0 transition-colors focus-visible:ring-2 md:h-11 md:w-11 md:min-w-11 [&_svg]:h-5 [&_svg]:w-5 [&_svg]:shrink-0 md:[&_svg]:h-5 md:[&_svg]:w-5',
            tone === 'danger'
...
export function EditorSection({
  ...
  return (
    <Disclosure.Root
      ...
      <div
        className="flex flex-col gap-2.5 border-b border-zinc-200/70 px-4 py-4 dark:border-zinc-800 md:flex-row md:items-center md:justify-between md:gap-3 md:px-6 md:py-5"
        ...
        <Disclosure.Heading className="min-w-0 flex-1">
          <Disclosure.Trigger
            ...
            <span className="inline-flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full border border-zinc-200 bg-zinc-50 text-zinc-500 dark:border-zinc-800 dark:bg-zinc-900/70 dark:text-zinc-300 md:h-11 md:w-11">
...
export function EditorEntry({
  ...
  const entryHeaderClassName =
    'flex flex-col gap-2.5 px-3.5 py-3 md:flex-row md:items-center md:justify-between md:gap-3 md:px-5 md:py-4'
