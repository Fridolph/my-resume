...
| 姓名   | 教育情况 | 专业     | 工作经验 | 当前状态 | 求职意向  | 微信        |
| :----- | :------- | :------- | :------- | :------- | :-------- | :---------- |
| 付寅生 | 本科毕业 | 通信工程 | 8 年     | 已离职   | 前端/全职 | 16602835945 |

- 在线简历：https://resume.fridolph.top
- Github：https://github.com/Fridolph
- 技术博客：https://blog.fridolph.top
...
- **知识共享：** 每月定期组织 CodeReview、内部建设和技术分享会，以促进团队交流；
...
- 参与小程序 uni-app 重构方案调研及推进（Vue3 + TS + tailwind + uView UI）
...
- 完成资产详情页面，通过 **Websocket** 获取展示终端相关信息，提高了性能和实时性
- 封装了接口请求、高级搜索、过滤器、PowerShell 等**业务组件**，提高开发效率
- 为告警、进程页需请求大量数据的场景设计预缓存方案，**提升了页面加载速度和性能**
...
- 负责静态页面及相关样式的编码工作，确保页面视觉效果和用户体验上均达到高标准
- 封装了工具模块：如滚动效果、全屏特效、工具栏、动画和过渡相关的 mixin 等
...
- [fridolph](https://github.com/Fridolph/Fridolph) 该项目整理个人关于前端相关学习资源、教程、文章、书籍等
